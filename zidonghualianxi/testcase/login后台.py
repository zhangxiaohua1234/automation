...
class TestApi:
    ...
    #         "goods_name": "自动化测试五",  # 注意：原curl中的乱码已修正为正确中文
    #         "goods_sn": "",
    #         "cat_name": "运动户外",
    #         "cat_id": "360",
    #         "addedCategoryName": "",
    ...
    def test_list(self):
        # 商城后台-管理中心商品列表查询
        url = 'http://115.28.108.130/newecshop/admin/goods.php?act=list'
        ...
        res = requests.post(url, headers=headers, data=url_params, verify=False)
